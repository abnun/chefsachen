...
export const config = {
  ...
  onPrepare: async () => {
    ...
    // Ein eigener HOME sorgt für einen leeren Datenordner je Lauf. Ohne das
    // liefe der Test gegen die Datenbank des vorherigen Laufs und wäre je nach
    // Reihenfolge grün oder rot.
